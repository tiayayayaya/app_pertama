...
import 'package:kostgo/screens/reviewpelangi.dart';
...
class Pelangi extends StatefulWidget {
  const Pelangi({super.key});

  @override
  State<Pelangi> createState() => _PelangiState();
}

class _PelangiState extends State<Pelangi> {
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const Reviewpelangi(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(

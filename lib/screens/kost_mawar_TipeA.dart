...
import 'package:kostgo/screens/ajukan_sewa.dart';
...
class KosMawar extends StatefulWidget {
  const KosMawar({super.key});

  @override
  State<KosMawar> createState() => _KosMawarState();
}

class _KosMawarState extends State<KosMawar> {

...
import 'package:kostgo/screens/reviewmelur.dart';
...
class Melur extends StatefulWidget {
  const Melur({super.key});

  @override
  State<Melur> createState() => _MelurState();
}

class _MelurState extends State<Melur> {
                    ...
                    children: [
                      ...
                      const Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text("5.0 (9)", style: TextStyle(fontSize: 14)),
                          SizedBox(width: 48),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const reviewmelur(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(

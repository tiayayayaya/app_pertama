...
import 'package:kostgo/screens/fotobravo.dart';
import 'package:kostgo/screens/review_kos_bravo.dart';
import 'package:kostgo/search/search.dart';
import 'package:kostgo/themes/colors_theme.dart';

class KostBravo extends StatefulWidget {
  const KostBravo({super.key});

  @override
  State<KostBravo> createState() => _KostBravoState();
}

class _KostBravoState extends State<KostBravo> {
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ReviewKosBravo(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Fotobravo(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(

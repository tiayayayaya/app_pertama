...
import 'package:kostgo/screens/reviewbenhil.dart';
import 'package:kostgo/search/lihatdetail.dart';
import 'package:kostgo/themes/colors_theme.dart';

class Benhil extends StatefulWidget {
  const Benhil({super.key});

  @override
  State<Benhil> createState() => _BenhilState();
}

class _BenhilState extends State<Benhil> {
                    ...
                    children: [
                      ...
                      const Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text("5.0 (15)", style: TextStyle(fontSize: 14)),
                          SizedBox(width: 48),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const reviewbenhil(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(

...
import 'package:kostgo/screens/reviewatlantik.dart';
import 'package:kostgo/search/lihatdetail.dart';
import 'package:kostgo/themes/colors_theme.dart';

class Atlantik extends StatefulWidget {
  const Atlantik({super.key});

  @override
  State<Atlantik> createState() => _AtlantikState();
}

class _AtlantikState extends State<Atlantik> {
                    ...
                    children: [
                      ...
                      const Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text("5.0 (6)", style: TextStyle(fontSize: 14)),
                          SizedBox(width: 48),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const Reviewatlantik(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
          ...
          Positioned(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 75), // Spasi antara ikon dan tombol
                Align(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const LihatDetail(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(

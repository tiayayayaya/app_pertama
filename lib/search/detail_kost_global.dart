...
import 'package:kostgo/screens/reviewglobal.dart';
import 'package:kostgo/search/lihatdetail.dart';
import 'package:kostgo/themes/colors_theme.dart';

class DetailGlobal extends StatelessWidget {
  const DetailGlobal({super.key});
                    ...
                    children: [
                      ...
                      const Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text("5.0 (10)", style: TextStyle(fontSize: 14)),
                          SizedBox(width: 48),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const reviewglobal(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
